...
export default class NyaaExtension {
    constructor() {
        this.baseUrl = 'https://sukebei.nyaa.si';
    }
    ...
    parseTorrentResults(html, exclusions = []) {
        try {
            ...
            console.error('Fehler in parseTorrentResults:', error);
            return [];
        }
    }
    ...
    filterAndSortResults(results, type) {
        try {
            ...
            console.error('Fehler in filterAndSortResults:', error);
            return [];
        }
    }
    ...
    generateHashFromLink(link) {
        try {
            ...
            console.error('Fehler in generateHashFromLink:', error);
            return 'fallback' + Date.now().toString(16).padStart(32, '0');
        }
    }
}
